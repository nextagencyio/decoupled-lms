...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact LearnPath Academy. We\'d love to hear from you about courses, enrollment, or technical support.',
  keywords: ['Contact LearnPath Academy', 'Support', 'Help', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about courses, enrollment, or technical support? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@learnpathacademy.com</p>
                    <p className="text-gray-600">support@learnpathacademy.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 890-1223</p>
